...
const baseToastManager = ToastPrimitive.createToastManager<Record<string, unknown>>()
...
const toast = Object.assign(baseToastManager, {
  show: (options: ToastOptions) =>
    baseToastManager.add(options as Parameters<typeof baseToastManager.add>[0]),
